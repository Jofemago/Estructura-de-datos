...
int main (void){
  cout << "NEW YORK MINCUT" << endl;
	cout << "CARGAMOS EL GRAFO"<< endl;
	Hora();
	AdjList<int, int> g("USA-road-d.NY.gr",true);
...
//---------------------------------------------------------------------------------------------------------------
  /*	cout << "CALCULAMOS EL DIAMETRO" << endl;
  	Hora();
  	int diametro= Diameter(g,BiggerCc.first,CompConect);
  	cout << " la componente conexa mas grande tiene diametro de " << diametro << endl;
  	cout << endl;*/
//-----------------------------------------------------------------------------------------------------------
